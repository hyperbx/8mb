...
reg add "%shellKey%\a_8MB\command" /ve /d "powershell \"%scriptPath%\" \"%%1\" 8 MB" /f

reg add "%shellKey%\b_25MB" /ve /d "25 MB" /f
reg add "%shellKey%\b_25MB\command" /ve /d "powershell \"%scriptPath%\" \"%%1\" 25 MB" /f

reg add "%shellKey%\c_50MB" /ve /d "50 MB" /f
reg add "%shellKey%\c_50MB\command" /ve /d "powershell \"%scriptPath%\" \"%%1\" 50 MB" /f
